...
| --- | --- | --- |
| **Invoice number** | Yes | Unique serial (e.g. `INV-2025-0042`). The system does not auto-generate this - you control the numbering scheme |
...
OwnPay does not auto-increment invoice numbers. You set the number manually when you create each invoice. This gives you flexibility to match your existing accounting system (e.g. `INV-2025-0042`, `REC-0042`, or any format you prefer).
