...
### 1. Install the OwnPay Skill

Download the [AI Skill](/developer/ai/skills) file and import it into your AI assistant. This teaches the assistant the OwnPay architecture, plugin conventions, and interface contracts so every prompt starts from informed context.

### 2. Connect the MCP server

Add the [MCP server](/developer/ai/mcp) to your AI tool. The server URL is `https://ownpay.org/docs/mcp`. Configuration instructions are available for Cursor, Claude Desktop, Claude Code, VS Code, and Windsurf.

### 3. Build with a prompt template

Pick a prompt template below, customize the placeholder values, and paste it into your AI assistant. The AI generates a complete, working plugin — manifest, classes, and all — using live docs for accuracy.
