...
<Tabs>
  <Tab title="Claude Code">
    ...
    curl -o ~/.claude/skills/ownpay/SKILL.md {{skillsUrl}}
  ...
  <Tab title="Cursor">
    ...
    ```bash
    curl -o .cursor/skills/ownpay/SKILL.md {{skillsUrl}}
    ```
  ...
  <Tab title="VS Code (Copilot)">
    ...
    ```bash
    curl -o .vscode/skills/ownpay/SKILL.md {{skillsUrl}}
    ```
  ...
  <Tab title="Gemini CLI">
    ...
    # Download the skill
    curl -o ~/.gemini/skills/ownpay/SKILL.md {{skillsUrl}}
    ```
  </Tab>
</Tabs>
