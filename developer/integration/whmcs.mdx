...
<CardGroup cols={2}>
  <Card title="WHMCS Marketplace" href="https://marketplace.whmcs.com/product/8845-ownpay-whmcs">
    Download the official module from the WHMCS Marketplace.
  </Card>

  <Card title="GitHub" href="https://github.com/own-pay/OwnPay-WHMCS">
...
| Field | Description |
| --- | --- |
| Display Name | Name shown to clients (for example "Credit/Debit Card / Mobile Banking") |
| API URL | Your OwnPay base URL (for example `https://pay.yourdomain.com`) |
