...
The OwnPay Companion App is an Android application that bridges your Android phone with your self-hosted OwnPay instance. Its **sole SMS-related purpose** is forwarding **incoming payment confirmation SMS** (e.g., mobile money receipts from bKash, Nagad, Rocket, Upay) to OwnPay for automatic transaction verification.
