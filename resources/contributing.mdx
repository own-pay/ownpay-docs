...
This project and everyone participating in it is governed by our [Code of Conduct](/resources/code-of-conduct). By participating, you are expected to uphold it. Please report unacceptable behavior to {{supportEmail}}.
...
Questions about contributing? Reach out at {{supportEmail}} or open a [discussion](https://github.com/own-pay/OwnPay/discussions).
