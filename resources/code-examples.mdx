...
$client = new Client('https://pay.yourbrand.com/api/v1', 'op_live_xxxxxxxxxxxxxxxxxxxxxx');
...
const client = new OwnPay('https://pay.yourbrand.com/api/v1', 'op_live_xxxxxxxxxxxxxxxxxxxxxx');
...
func main() {
	client := ownpay.NewClient("https://pay.yourbrand.com/api/v1", "op_live_xxxxxxxxxxxxxxxxxxxxxx")
...
public class Main {
    public static void main(String[] args) {
        Client client = new Client(
            ...
            "op_live_xxxxxxxxxxxxxxxxxxxxxx"
        );
