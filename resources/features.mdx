...
## \u{1F3C6} Flagship - Sovereign White-Label Architecture
...
*For contribution guidelines, see [CONTRIBUTING.md](/resources/contributing). For security reporting, see [SECURITY.md](https://github.com/own-pay/OwnPay/blob/main/SECURITY.md). For architecture details, see [ARCHITECTURE.md](/resources/architecture).*
