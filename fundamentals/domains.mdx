...
description: "Serve each brand's checkout on its own domain (for example, pay.yourbrand.com) with automated DNS verification, SSL certificate provisioning, and tenant isolation."
