...
<CardGroup cols={3}>
  <Card title="Brands" icon="building-store" href="/fundamentals/brands">
    Isolated merchant tenants - each brand has its own gateways, domain, staff, API keys, and ledger.
  </Card>

  <Card title="Payment flow" icon="circle-arrow-right" href="/fundamentals/payment-flow">
  ...
  <Card title="Ledger" icon="book" href="/fundamentals/ledger">
  ...
  <Card title="Domains" icon="world" href="/fundamentals/domains">
