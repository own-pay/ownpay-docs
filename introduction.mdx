...
<CardGroup cols={2}>
  ...
  <Card title="Multi-tenant brands" icon="building-store">
  ...
  <Card title="White-label domains" icon="world">
...
<CardGroup cols={2}>
  ...
  <Card title="Developer hub" icon="tool" href="/developer/quickstart">
...
<CardGroup cols={2}>
  <Card title="I am a merchant owner" icon="building-store" href="/quickstart">
